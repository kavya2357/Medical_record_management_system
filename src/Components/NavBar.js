...
function NavBar() {
  ...
  return (
    <div className='header'>
        <Link to="/Homepage">
            <span className='logo'>CertifyBlock</span>
        </Link>
        ...
        <div className='header_nav'>
            ...
            <div className='option_basket'>
              <MailIcon className='cart'/>
            </div>

            <div className='option_basket'>
              <NotificationsIcon className='cart'/>
            </div>
            
            <Link to="/">
              <div className='option_basket'>
              <button onClick={onConnectWallet} style={{background: "black"}}>
                  
                  {account ? account : <AccountCircle className='cart'/>}
              </button>
